...
export default function Login() {
  ...
  const defaultTab = location.search.includes("tab=signup") ? "signup" : "login"
              ...
              <form onSubmit={handleLoginSubmit}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                  >
                    <img src="https://placehold.co/20x20/e2e8f0/1e293b?text=G" alt="Google" className="mr-2 h-5 w-5" />
                    Google
                  </Button>
                </CardContent>
              </form>
